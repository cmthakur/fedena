...
ActiveRecord::Schema.define(:version => 20130110095412) do
  ...
  add_index "students", ["first_name", "middle_name", "last_name"], :name => "index_students_on_first_name_and_middle_name_and_last_name", :limit => {"first_name"=>nil, "last_name"=>nil, "middle_name"=>nil}
