...
ActiveRecord::Schema.define(:version => 20130110095412) do
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"observable_id"=>nil, "exam_id"=>nil, "observable_type"=>nil, "student_id"=>nil, "batch_id"=>nil}
  ...
  add_index "configurations", ["config_key"], :name => "index_configurations_on_config_key", :limit => {"config_key"=>nil}
  add_index "configurations", ["config_value"], :name => "index_configurations_on_config_value", :limit => {"config_value"=>nil}
  ...
  add_index "employees", ["employee_number"], :name => "index_employees_on_employee_number", :limit => {"employee_number"=>nil}
  ...
  add_index "students", ["admission_no"], :name => "index_students_on_admission_no", :limit => {"admission_no"=>nil}
  add_index "students", ["batch_id"], :name => "index_students_on_batch_id", :limit => {"batch_id"=>nil}
  add_index "students", ["first_name", "middle_name", "last_name"], :name => "index_students_on_first_name_and_middle_name_and_last_name", :limit => {"last_name"=>nil, "first_name"=>nil, "middle_name"=>nil}
  ...
  add_index "users", ["username"], :name => "index_users_on_username", :limit => {"username"=>nil}
